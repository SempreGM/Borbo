    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="mx-auto max-w-4xl rounded-3xl border border-border bg-card p-10 shadow-sm">
        ...
        <p className="text-muted-foreground mb-8">
          Na borbô, valorizamos sua privacidade e protegemos seus dados
          pessoais com cuidado.
        </p>
        ...
        <div className="space-y-6 text-sm text-foreground">
          <section>
            ...
            <p className="text-muted-foreground">
              Coletamos informações como nome, e-mail, endereço de entrega,
              telefone e histórico de compras para oferecer uma experiência
              mais personalizada.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              sobre compras, melhorar o atendimento e apresentar ofertas
              relevantes.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              Protegemos suas informações com medidas técnicas e administrativas
              para reduzir riscos de acesso não autorizado.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              serviços essenciais para entrega, atendimento e pagamento.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              entrando em contato pelo e-mail oi@borbo.com.br.
            </p>
          </section>
        </div>
